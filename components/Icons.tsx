...
export const RewindIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M11 18V6l-8.5 6 8.5 6zm-2.5-6L11 9.23v5.54L8.5 12zM20 18V6l-8.5 6 8.5 6zm-2.5-6L20 9.23v5.54L17.5 12z" />
    </svg>
);

export const FastForwardIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M4 18l8.5-6L4 6v12zm2-8.14L9.97 12 6 14.14V9.86zM13 6v12l8.5-6L13 6zm2 3.86L18.97 12 15 14.14V9.86z" />
    </svg>
);
